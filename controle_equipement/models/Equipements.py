...
class Equipement(models.Model):
    ...
    periode = fields.Integer(
        string='Nombre de jours entre controle.',
        default=30
    ...
    # @api.one
    # @api.depends(type_controle)
    # def _depends_periode_type(self):
    #     p=30
    #     if self.type_controle == '1':
    #         p= self.write({'periode': 1})  # Journalier
    #     elif self.type_controle == '2':
    #         p= self.write({'periode': 7})  # Hebdomadaire
    #     elif self.type_controle == '3':
    #         p= self.write({'periode': 30})  # Mensuel
    #     else:
    #         p= self.write({'periode': 365})  # Annuelle
    #     return p
